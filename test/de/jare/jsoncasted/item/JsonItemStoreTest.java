...
public class JsonItemStoreTest {
    ...
    /**
     * Test source resources tracking.
     */
    @Test
    public void testSourceResources() {
        JsonItemStore store = new JsonItemStore();
        
        // Note: We can't easily create a JsonResource without a file,
        // but we can test that the list is initially empty
        assertNotNull(store.getSourceResources());
        assertTrue(store.getSourceResources().isEmpty());
    }
}
