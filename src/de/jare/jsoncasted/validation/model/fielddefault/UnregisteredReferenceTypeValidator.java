 ...
 * </copyright>
 */
package de.jare.jsoncasted.validation.model.fielddefault;
import de.jare.jsoncasted.validation.core.Diagnostic;

import de.jare.jsoncasted.model.FieldKind;
import de.jare.jsoncasted.model.JsonModel;
import de.jare.jsoncasted.model.item.JsonField;
import de.jare.jsoncasted.validation.model.FieldValidator;
import de.jare.jsoncasted.validation.model.ValidationContext;

/**
 * Validator that checks if a reference field's target type is registered in the model. Reference fields should point to
 * types that exist in the model registry. This is a warning-level diagnostic since the reference might be valid at
 * runtime.
 *
