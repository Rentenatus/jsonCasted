...
public class ValidationContext {
    ...
    private final ValidationResult<ValidationDiagnostic> result;
     ...
     */
    public ValidationContext(JsonModel model, ValidationResult<ValidationDiagnostic> result) {
        this.model = model;
        this.result = result;
     ...
     * @return the result
     */
    public ValidationResult<ValidationDiagnostic> getResult() {
        return result;
    }
