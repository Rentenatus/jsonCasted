...
/**
 * The JsonLongBuilder class handles the conversion of JSON numeric values into
 * Java primitive long types. It supports building individual values, lists, and
 * arrays.
 *
 * @author Janusch Rentenatus
 */
public class JsonLongBuilder implements JsonModellClassBuilder {

    /**
     * Returns the primitive long class type.
     *
    ...
    /**
     * Builds a long value from a JSON item. If the JSON value is "null" or
    ...
    public Object build(JsonClass jClass, JsonItem jsonItem) {
        ...
        return value == null || "null".equals(value) ? 0 : Long.valueOf(value);
    }
    ...
    /**
     * Builds an array of long values from a JSON array.
     *
     * @param jType The JSON type for conversion.
     * @param listIterator Iterator over JSON items.
    ...
    public long[] buildArray(JsonType jType, Iterator<JsonItem> listIterator, int size) throws JsonBuildException {
        ...
        while (listIterator.hasNext()) {
            ret[i++] = Long.parseLong(listIterator.next().getStringValue());
        }
        return ret;
    }
