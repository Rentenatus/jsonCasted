...
/**
 * Helper class to traverse all types in a JsonModel. This class is in the same package as JsonModel to access
...
public class JsonModelTypeTraverser {
    ...
    /**
     * Visits all types in the model with a consumer. This includes JsonClass, JsonInter, and JsonEnum (stored as
     * JsonClass).
     *
    ...
    public static void traverseAllTypes(JsonModel model, Consumer<JsonType> typeConsumer, Consumer<JsonField> fieldConsumer) {
        ...
        for (JsonInter inter : model.interfaces.values()) {
            ...
            for (JsonClass implClass : inter.iterable()) {
