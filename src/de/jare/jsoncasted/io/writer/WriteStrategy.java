...
/**
 * Strategy interface for writing JSON structures during serialization. Implementations of this interface define how
 * JSON nodes, objects, arrays, and primitives are written to the output, including formatting and path tracking.
 *
 * <p>
 * This interface provides methods for writing different JSON elements:
 * <ul>
...
public interface WriteStrategy {
    ...
    default void writeStartFile() {
        // NoOp
    }

    default void writeEndFile() {
        // NoOp        
    }
     ...
     */
    public void writeStartObject(JsonClass jClassOrNull, Object ob, JsonField parentField, Object parent, boolean needsCast, boolean needsClassDef, WriteNodePath iString);
     ...
     * @param iString the indentation path for formatted output
     */
    public void writeEndObject(final JsonClass jClassOrNull, final Object ob, boolean isFollowing, boolean hasFieldKeys, WriteNodePath iString);
    ...
    /**
     * Determines whether an object should be skipped during processing. This can be used to avoid processing objects
     * that have already been written or should not be included in the output.
     *
    ...
    /**
     * Writes a JSON node value. This method handles the actual value output for various JSON node types.
     *
