 ...
 *
 * <p>
 * This class handles the initial parsing of JSON content and coordinates with
 * other parsers ({@link ObjectParser}, {@link ListParser}, {@link StringParser},
 * {@link CastingParser}) to build the complete JSON tree.</p>
 *
 * <p>
 * After parsing the root node, it also:</p>
 * <ul>
 * <li>Scans for wood provider definitions</li>
 * <li>Builds the linking set for cross-resource references</li>
 * <li>Processes and stores any exceptions from the scanning/building
 * process</li>
 * </ul>
 *
...
public class RootParser {
     ...
     *
     * <p>
     * This method performs the complete parsing pipeline including:</p>
     * <ol>
     ...
     *
     * <p>
     * Recognizes and delegates to appropriate parsers based on the first
     * character:</p>
     * <ul>
