 ...
 *
 * <p>
 * Each level determines when and how interface resolution and class identification should occur during JSON parsing.
 * Higher levels provide more explicit type information at the cost of potentially more verbose JSON.</p>
 *
 * <p>
 * Casting levels control:</p>
 * <ul>
...
public enum JsonCastingLevel {
     ...
     * <p>
     * Compatible with standard JSON but cannot resolve interfaces or polymorphic types. Use when type information is
     * determined by context only.</p>
     */
    NEVER(0),
    /**
     * Require class definition fields only when necessary for interface resolution.
     * <p>
     * This is the most lenient level that still supports interface types.</p>
     */
    NECESSARY_CLASS_DEF(4),
    /**
     * Perform casting only when interfaces mask different underlying classes.
     * <p>
     * Casting occurs when the JSON structure alone cannot determine the concrete type.</p>
     */
    NECESSARY_CAST(5),
    /**
     * Always include class definition fields during serialization.
     * <p>
     * Ensures type information is preserved even when it could be inferred.</p>
     */
    ALWAYS_CLASS_DEF(9),
    /**
     * Always perform type casting, even when the structure provides clear distinction.
     * <p>
     * Most explicit level, ensures type information is always available.</p>
     */
    ALWAYS_CAST(10);
